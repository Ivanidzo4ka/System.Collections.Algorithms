...
namespace System.Collections.Algorithms
{
    internal class XTFastTrie
    {
        ...
        public byte Min => _begin != null ? _begin.Value : byte.MaxValue;

        public byte Max => _end != null ? _end.Value : byte.MinValue;
